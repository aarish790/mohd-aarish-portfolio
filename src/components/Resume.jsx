    ...
    return(  
      <div className = "mt-5 d-flex justify-content-left" className="wrapper">
        ...
        <aside>
          ...
          <Zoom in={true}><h1>MOHD AARISH SIDDIQUI</h1></Zoom>
          <Zoom in={true}><h3 className="r"><DeveloperModeIcon fontSize="large"></DeveloperModeIcon>Full Stack Web Developer</h3></Zoom>
          <Zoom in={true}><p className="p">I'm passionate about web development.I had spend some good time learning the concepts involved in this. I have a keen interest in developing some sites from school time.I want to test my skills and endurance in the cooperate world.This will not only help in increasing my skills but also benefit others who want to learn this and also wanted their website work to be done.</p></Zoom>
          <Zoom in={true}><h3 className="r"><HomeIcon fontSize="large"></HomeIcon>Address</h3></Zoom>
          <Zoom in={true}><p className="p">H.no: B-32,Purani Colony,Kichha Sugar Company Ltd. Kichha Udham Singh Nagar,Uttarakhand,263148</p></Zoom>
        ...
        <Zoom in={true}><main><Zoom in={true}><h3 className="r"><CastForEducationIcon fontSize="large"></CastForEducationIcon>{''}Education</h3></Zoom>
        <Zoom in={true}><p><big>MATRICULATION</big> <i>from St Peter Senior Secondary School,Kishanpur,Kichha</i>{' '}
        passed with 9.4 cgpa in CBSE Board (2013-2014)</p></Zoom>
        <Zoom in={true}><p><big>INTERMEDIATE/+2</big> <i>from St Peter Senior Secondary School,Kishanpur,Kichha</i>{' '}
        passed with 88.6% in CBSE board (2015-2016)</p></Zoom>
        <Zoom in={true}><p><big>BACHELOR OF TECHNOLOGY (BTECH.)</big> <i>from National Institute Of Technology,Uttarakhand,{' '}</i>{' '}
        8.35 cpga (upto 5th semester) (2017-2021)</p></Zoom>
        <Zoom in={true}><h3 className="r"><LocalMallIcon fontSize="large"></LocalMallIcon>Experience</h3></Zoom>
        <Zoom in={true}><p>I am a fresher in the web development field, but eager to interact with new people to learn new things and enhance my skills.I have done some practice web development projects which are available at my github account
        .</p></Zoom>
        <Zoom in={true}><h3 className="r"><StarsIcon fontSize="large"></StarsIcon>Certificates</h3></Zoom>
        <Zoom in={true}><p>Certification in <big>Full Stack Web Development</big> from <big>Udemy</big></p></Zoom>                                                                                             
